...
if __name__ == "__main__":
    ...
    parser.add_argument("-dn", "--data_name", type=str, help="Dataset name.", default="Math")
    parser.add_argument("-df", "--data_file", type=str, help="Path to dataset.", default="../Datasets/template_labels.tsv")
    ...
    parser.add_argument("-l", "--max_len", type=int, help="Maximum number of words in a sentence.", default=145)
    parser.add_argument("-h", "--hidden_size", type=int, help="Number of Units in LSTM layer.", default=50)
